# Web Scraping - Football Tables Standings
<p align="center">
  <img width="900" height="200" src="https://e3.365dm.com/tvlogos/channels/1303-Logo.png?U2t5IFNwb3J0cyBQcmVtaWVyIExlYWd1ZQ==">
</p>
...
# About The Project
The main goal of this project is to extract data from football standings tables in various leagues across the world, starting with the name of the top-ranked team, the amount of points, victories, losses, and other information. The data obtained is stored in a database and extracted in an Excel or CSV dataset.
